This repository contains SQL queries for analyzing a music store database. The queries are categorized into three sets: Easy, Moderate, and Advanced, covering various aspects of the dataset.
